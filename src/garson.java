...
public class garson extends javax.swing.JFrame {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (i = mp.getMasaid(); i <= mp.getMasaid(); i++) {
                    ...
                    label.setIcon(ResizeImage("src/img/restaurant-table-filled.png", null, label));
                    a = a + 75;
    ...
    public void kampanyaDoldur() {
        ...
        try {
            ...
            System.err.println("kampanya getirme hatası:" + e);
        }
    }
    ...
    public void hazirSiparis() {
        
        TimerTask hazirsiparis = new TimerTask() {
            @Override
            public void run() {
                hazirSiparisTabloDoldur();
            }
        ...
        Timer tm = new Timer();
        tm.schedule(hazirsiparis, 0, 2000);
    ...
    public void hazirSiparisTabloDoldur() {
        try {
            ...
            while (rs.next()) {
                dtm.addRow(new Object[]{rs.getInt("masaid"), rs.getString("madi"), rs.getString("kullaniciAdi"),rs.getString("yadi"), rs.getInt("sadet"), rs.getString("menuadi"), rs.getInt("madet")});
            }
    ...
    private void initComponents() {
        ...
        jLabel31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/kahve-1000x600.jpg"))); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addComponent(jLabel31, javax.swing.GroupLayout.PREFERRED_SIZE, 774, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(138, 138, 138))
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(jLabel31, javax.swing.GroupLayout.DEFAULT_SIZE, 619, Short.MAX_VALUE))
        );
        ...
        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/vector_art_logo_hot_coffee_cup.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String q = "call siparisIptal('" + sipid + "')";
            PreparedStatement ps = db.preBaglan(q);
            int yaz = ps.executeUpdate();
            if (yaz > 0) {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try {
            ...
            System.err.println("durum güncelleme hatası:");
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            System.err.println("siparis görüntüleme hatası :  " + e);
        }
  ...
  static String adi,sifresi=null;
    ...
    public void siparisTabloDoldur() {
        try {
            ...
            System.err.println("Siparis getirme hatası : " + e);
        }
    }
