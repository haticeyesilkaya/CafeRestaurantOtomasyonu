...
public class Mutfak extends javax.swing.JFrame {
    ...
    public void siparisEkranı() {
        try {
            ...
            while (rs.next()) {
                dtm.addRow(new Object[]{rs.getInt("masaid"), rs.getString("madi"), rs.getString("yadi"), rs.getInt("sadet"),rs.getString("menuadi"), rs.getInt("madet")});
            }
            jTable1.setModel(dtm);

        } catch (Exception e) {
            System.err.println("asci paneli siparis getirme hatası : " + e);
        }
    }
    //masalar
    ...
    public void asciSiparisGoruntu(int secim) {
        try {
            ...
            while (rs.next()) {
                ...
                //button.setText(rs.getString("menuresim"));
                    i = i + 75;
                    button.addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent e) {
            ...
            this.repaint();
               ...
               System.err.println("buton oluşturma hatası : " + e);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(255, 165, 79));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            System.err.println("asci label hatası : " + e);
      }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String q = "call asciSiparisHazir('" + secim + "')";
